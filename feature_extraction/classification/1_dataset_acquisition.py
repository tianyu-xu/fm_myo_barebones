...
def make_single_acquisition(trial_len, message_to_the_user = False):
    # This function persforms a single acquisition EMG data for a specified amount of seconds.
...
def main():
    ...
    gestures = ['fist', 'radial', 'ulnar','extension','flextion','rest']#, 'pron', 'supi'] # Classes to acquire data for
